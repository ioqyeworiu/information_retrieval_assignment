...
def compute_idf(inverted_index: dict[str, list[str]], total_documents: int) -> dict[str, float]:
    idf = {}
...
class Bm25Okapi(BaseModel):
    ...
    def fit(self, documents: list[tuple[str, str]], k1: float = 1.5, b: float = 0.75) -> dict[str, float]:
        self.k1 = k1
        self.b = b
